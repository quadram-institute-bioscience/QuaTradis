...
from quatradis.artemis.experiment import ExperimentMetaData, ExperimentCollection


def artemis_project_run(args):
    ap = ArtemisProject(args.outputfile, args.verbose, args.experiments_metadata, args.reference, args.controls)
