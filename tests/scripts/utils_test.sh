...
./tradis utils essentiality --output_dir=output_essential --minimum_threshold=1 $ESS_DATA_DIR/small_case.insert_site_plot.gz $ESS_DATA_DIR/annotation.embl
rm -r output_essential
echo "ok"
